...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8bfb295920cbdbda0914";
...
var _newsCard = __webpack_require__(5);
...
var Header = function () {
    ...
    _createClass(Header, [{
        ...
        value: function renderCardList(articlesCollection) {
            ...
            document.querySelector('.no-results-caption').classList.add('hide');
            articlesCollection.map(function (_ref2) {
                ...
                return newsListSection.innerHTML += (0, _newsCard2.default)({
                    author: author || '',
                    title: title || '',
                    publishedAt: _this2.extractDate(publishedAt) || '',
                    name: name || '',
                    description: description || '',
                    url: url || '',
                    urlToImage: urlToImage || _this2.BLANK_IMAGE_URL
                });
            });
        }
    }, {
        ...
        value: function bindEventListeners() {
            ...
            Object.keys(this.elementsMap).map(function (domElKey) {
                return _this3.elementsMap[domElKey].element.addEventListener(_this3.elementsMap[domElKey].event, _this3.elementsMap[domElKey].callback);
            });
        }
    }, {
        key: 'create',
...
var _finally = __webpack_require__(13);
