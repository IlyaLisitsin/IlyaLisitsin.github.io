...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "63f8ea52f43ef74397b3";
...
var _newsCard = __webpack_require__(129);
...
var Header = function () {
    ...
    _createClass(Header, [{
        ...
        value: function fetchNews() {
                            ...
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    return fetch(url).then(function (res) {
                                        ...
                                        _response = articles;
                                        bindedRenderCardList(_response);
                                    });
            ...
            var textQuery = this.headerDomModel.querySelector('#header-input').value || 'news';
            var languageQuery = this.headerDomModel.querySelector('input[name="language"]:checked').value || 'en';
            var sourcesQuery = this.headerDomModel.querySelector('input[name="sources"]:checked').value || 'google-news';
            var url = this.ENDPOINT + '?q=' + textQuery + '&language=' + languageQuery + '&sources=' + sourcesQuery + '&pageSize=10&apiKey=' + this.API_KEY;
            ...
            var bindedRenderCardList = this.renderCardList.bind(this);
            var response = null;
        ...
        key: 'renderCardList',
        value: function renderCardList(articlesCollection) {
            var _this = this;

            var newsListSection = document.querySelector('.news-list');
            ...
            document.querySelector('.no-results-caption').classList.add('hide');
            articlesCollection.map(function (_ref3) {
                var author = _ref3.author,
                    title = _ref3.title,
                    publishedAt = _ref3.publishedAt,
                    name = _ref3.source.name,
                    description = _ref3.description,
                    url = _ref3.url,
                    urlToImage = _ref3.urlToImage;
                return newsListSection.innerHTML += (0, _newsCard2.default)({
                    author: author || '',
                    title: title || '',
                    publishedAt: _this.extractDate(publishedAt) || '',
                    name: name || '',
                    description: description || '',
                    url: url || '',
                    urlToImage: urlToImage || _this.BLANK_IMAGE_URL
                });
            });
        }
    }, {
        key: 'extractDate',
        value: function extractDate(dateStr) {
        ...
        value: function bindEventListeners() {
            ...
            Object.keys(this.elementsMap).map(function (domElKey) {
                return _this2.elementsMap[domElKey].element.addEventListener(_this2.elementsMap[domElKey].event, _this2.elementsMap[domElKey].callback);
            });
        }
    }, {
        key: 'create',
        value: function create() {
            ...
            this.headerDomModel.innerHTML = (0, _header2.default)();
            this.bindElements();
...
var _newsCard = __webpack_require__(130);

var _newsCard2 = _interopRequireDefault(_newsCard);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _newsCard2.default;
...
var headerTpl = function headerTpl() {
...
var _finally = __webpack_require__(137);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(134).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(46), __webpack_require__(136)))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(46), __webpack_require__(339)(module)))
