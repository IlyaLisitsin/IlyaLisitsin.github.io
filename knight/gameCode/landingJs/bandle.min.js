...
return jQuery;});$(document).ready(function(){$('#top-nav').on('click','a',function(event){event.preventDefault();var id=$(this).attr('href'),top=$(id).offset().top;$('body, html').animate({scrollTop:top},1000);var arr=$('#top-nav ul').children();for(var i=0;i<arr.length;i++){$(arr[i]).removeClass('active');}
$(this).parent().addClass('active');});var screenshots=$('#screenshots').offset().top;var cont=$('#controls').offset().top;var enem=$('#enemyes').offset().top;var items=$('#items').offset().top;var menu=$('#top-nav ul').children();$(window).scroll(function(){let scr=$(window).scrollTop();if(scr>230){$('.logo').stop().animate({'font-size':'36px'},300);}
else{$('.logo').stop().animate({'font-size':0},300);}
if(scr<800){for(var i=0;i<menu.length;i++){$(menu[i]).removeClass('active');}}
else if(scr>=screenshots&&scr<cont){for(var i=0;i<menu.length;i++){$(menu[i]).removeClass('active');}
$(menu[0]).addClass('active');}
else if(scr>=cont&&scr<enem){for(var i=0;i<menu.length;i++){$(menu[i]).removeClass('active');}
$(menu[1]).addClass('active');}
else if(scr>=enem&&scr<items){for(var i=0;i<menu.length;i++){$(menu[i]).removeClass('active');}
$(menu[2]).addClass('active');}
else if(scr>=items){for(var i=0;i<menu.length;i++){$(menu[i]).removeClass('active');}
$(menu[3]).addClass('active');}});});$('.item img').on('click',function(){var src=$(this).attr('src');$('body').append('<div class="popup">'+'<div class="popup-bg"></div>'+'<div class="popup-img-wrap">'+'<img src="'+src+'" class="popup-img">'+'<div class="close">&times;</div>'+'</div>');$('.popup-img-wrap').css({'margin-top':$(window).scrollTop()+60});$('.popup').fadeIn(400);$('.popup').on('click',function(){$('.popup').fadeOut(400);setTimeout(function(){$('.popup').remove();},400);});});$('.nav-hamb').on('click',function(){$('.nav-mobile').animate({'right':0},400);});$('.nav-mobile-close').on('click',function(){$('.nav-mobile').animate({'right':'-200px'},400);});$('.nav-mobile ul li').on('click',function(){$('.nav-mobile').animate({'right':'-200px'},400);});